...
/*
 This table can be used as the drilldown view. It prepares the important columns (Order Type, Posting Period, MRR) to be
...
reportdrilldown AS (
    SELECT
        cnrc.ordertype,
        CASE
            WHEN cnrc.ordertype = 'Churn' THEN cnrc.postingperiodid
            ELSE macp.periodid
        END AS postingperiodid,
        CASE
...
/*
 This table contains the information needed in the requirements/mockup
 */
reportsummary AS (
    SELECT
        postingperiodid,
